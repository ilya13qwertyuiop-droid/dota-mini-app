  ...
  questions: [
    {
      ...
      answers: [
        { text: "Середина игры — хочу почувствовать силу уже к 20–30 минуте.", tags: ["peak_midgame"] },
    ...
    },
    {
      ...
      answers: [
        { text: "Ближний бой — не против подойти к врагу вплотную.", tags: ["melee"] },
    ...
    },
    {
      ...
      answers: [
        { text: "Могу инициировать файт — стараюсь убивать ключевых вражеских героев.", tags: ["fight_diver"] },
    ...
    },
    {
      ...
      answers: [
        ...
        { text: "Средне — когда команда рядом могу сносить строения.", tags: ["push_medium"] },
        { text: "Плохо — пусть другие пушат, я хочу фармить и убивать.", tags: ["push_bad"] }
      ]
    },
    {
      ...
      answers: [
        ...
        { text: "Средняя сложность — пару комбинаций/навыков, но без экстремального микро.", tags: ["medium"] },
